...
{
  [Serializable()]
  public partial class K2_StatisticProcess : EntityBase
  {
    public K2_StatisticProcess()
    {
            TableName = "K2_StatisticProcess";
            Schema="dbo";
    ...
    PrimaryKeys.Add("StatisticId");
      ...
      {
           PropertyNames = new string[] { "StatisticId","StatMonth","ProcessCode","ProcessName","AllCount","AvgDowithTime" };
      }
