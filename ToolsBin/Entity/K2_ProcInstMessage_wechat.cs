...
{
  [Serializable()]
  public partial class K2_ProcInstMessage_wechat : EntityBase
  {
    public K2_ProcInstMessage_wechat()
    {
            TableName = "K2_ProcInstMessage_wechat";
            Schema="dbo";
    ...
    PrimaryKeys.Add("Idx");
      ...
      {
           PropertyNames = new string[] { "Idx","ProcInstId","CreateTime","ProcCode","ProcInstViewUrl","ReceiveLoginName","ReceiveUserName","wechatuserid","wechatname","SendLoginName","SendUserName","MessageTitle","MessageContent","MessageType","MessageTemplateType","IsDelete","IsRead","SendType","Ext1","Ext2" };
      }
      ...
      /// 
      /// </summary>
      public System.String wechatuserid
      {
          get{return getProperty<System.String>("wechatuserid");}
          set{setProperty("wechatuserid",value ,1550);}
      }

      /// <summary>
      /// 
      /// </summary>
      public System.String wechatname
      {
          get{return getProperty<System.String>("wechatname");}
          set{setProperty("wechatname",value ,1550);}
      }
