...
{
  [Serializable()]
  public partial class K2_StatisticProcInst : EntityBase
  {
    public K2_StatisticProcInst()
    {
            TableName = "K2_StatisticProcInst";
            Schema="dbo";
    ...
    PrimaryKeys.Add("StatisticId");
      ...
      {
           PropertyNames = new string[] { "StatisticId","StateMonth","ProcInstId","ProcessCode","ProcessName","StartTime","EndTime","DowithTime" };
      }
